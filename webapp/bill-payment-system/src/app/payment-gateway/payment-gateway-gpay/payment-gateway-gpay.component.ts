...
@Component({
  selector: 'app-payment-gateway-gpay',
  templateUrl: './payment-gateway-gpay.component.html',
  styleUrls: ['./payment-gateway-gpay.component.css']
})
export class PaymentGatewayGpayComponent implements OnInit {
  ...
  patchValues(){  
    this.paymentForm.patchValue({
      gpayName: this.paymentDetails.nameOnCard,
      gpayNumber: this.paymentDetails.mobileNumber
    });
}
  ...
  onPaid() {
    ...
    let paymentGatgewayName = "GooglePay";
